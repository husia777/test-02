...
class TaskService:
    ...
    async def get_tasks_by_filter(self, skip: int, limit: int, sort_field: AvailableFilters, closure_status,
                                  ...
                                  shift_start_time,
                                  shift_end_time):
        return await self.task_repository.get_tasks_by_filter(skip, limit, sort_field, closure_status,
                                                              shift_task_description,
                                                              line,
                                                              shift,
                                                              crew,
