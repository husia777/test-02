...
async def get_task_by_id(task_id: int, task_service: TaskService = Depends(Stub(task_service_provider))):
...
async def get_all_tasks(task_service: TaskService = Depends(Stub(task_service_provider))):
